...
SCENE_CONFIG_DIR="dependency_data_sample"
OUTPUT_DIR="dependency_results_final_${EXPERIMENT_TYPE}"
LOG_DIR="dependency_logs_final_${EXPERIMENT_TYPE}"
...
while IFS= read -r scene_path; do
    ...
    python inference_dependency.py \
