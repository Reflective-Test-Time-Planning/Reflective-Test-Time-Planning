...
def process_videos(videos, video_processor, mode='random', device=None, text=None):
    ...
    new_world_points = [video['world_points'] for video in new_videos]
    ...
    videos_dict['world_points'] = torch.stack(new_world_points, dim=0)
    print(videos_dict['world_points'].shape, videos_dict['world_points'].shape)
    print(videos_dict['images'].shape, videos_dict['images'].shape)
