...
def eval_model(args):
    ...
    with open ('/data2/whu/data/hm3d/train_data/Captions/llava-3d_data_Feb26_v6_medium_13K_caption_episodic_mem_v2_natural_cap_sum_diff_evaluation_samples.json', 'r') as f:

    #open('/local1/whu/data/hm3d/train_data/Captions/llava-3d_data_Feb26_v6_medium_13K_caption_episodic_mem_v2_natural_cap_sum_diff.json', 'r') as f:
                #llava-3d_data_Feb26_v6_medium_13K_caption_episodic_mem_v2_natural_cap.json', 'r') as f: 
        #'/local1/whu/llava_3d_files/llava-3d_data_Feb26_v6_medium_13K_caption_episodic_mem_v2.json', 'r') as f:
     #llava-3d_data_Feb26_v6_medium_13K_caption_episodic_mem.json', 'r') as f:
              #/data2/whu/checkpoints_llava3d/llava-3d_data_Feb26_v6_medium_41K_caption_mem_random50val.json', 'r') as f:
    # /local1/whu/checkpoints_llava3d/sample.json', 'r') as f: 
    ...
    # random.seed(123)
    # annotations = random.sample(annotations, 50)
    ...
    for ann in tqdm(annotations):
        ...
        # obj_result, evaluation_log, valid, states = validate_trajectory(room_order, gt_trajectory,all_room_objects,break_on_error=True)
        ...
        video_paths = ann['video']
        video_paths = ['/local1/whu/data/hm3d/semantic_room_data/original_2d_gt_seg_multiple_x_0227_train_original_room_all/'+v for v in video_paths]
        training_conv = ann['conversations']
    ...
    outputfile = '3d_data_0323_Cap_Sumdiff' + args.model_path.split('/')[-1] + '.json'
