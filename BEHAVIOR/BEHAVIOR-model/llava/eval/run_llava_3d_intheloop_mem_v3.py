...
from validate_traj_wenbo_loose import validate_trajectory
...
def eval_model(args):
    ...
    # with open('/local1/whu/data/hm3d/train_data/llava-3d_data_Feb28_v6_medium_180_scenes_18k_geminiv7_annotation_memv3_3k_cot_wentrooms.json', 'r') as f:   
    ...
    for ann in tqdm(annotations):
        ...
        video_paths = ['/local1/whu/data/hm3d/semantic_room_data/original_2d_gt_seg_multiple_x_0226_v6_medium_180scenes_18k_gemini20flash_v7/'+v for v in video_paths]
    ...
    # ["/local1/whu/data/hm3d/semantic_room_data/original_2d_gt_seg_multiple_x_0106_addobjects/hm3d/00031-Wo6kuutE9i7_0", "/local1/whu/data/hm3d/semantic_room_data/original_2d_gt_seg_multiple_x_0106_addobjects/hm3d/00031-Wo6kuutE9i7_3"]' \
        ...
        for j in range(len(training_conv)//2):
            ...
            k = 0
            for train_conv in training_conv[:count]:
                if train_conv['from'] == 'human':
                    ...
                    if len(last_out) != 0 and k < len(last_out):  
                        ...
                        last_out.append(train_conv['value'])
                else: 
                    print('unknown role \n\n\n')  
        ...
        # outputs = outputs.strip()
        # print(outputs)
        ann['prediction'] = all_outputs
        all_predictions.append(ann)

    outputpath = '/home/whu/vl_research/MultiPLY/evaluation/evaluation_output'
    outputfile = '3d_data_Feb26_train136_multirooms_0.2voxelep12_medium_v6' + args.model_path.split('/')[-1] + '.json'
