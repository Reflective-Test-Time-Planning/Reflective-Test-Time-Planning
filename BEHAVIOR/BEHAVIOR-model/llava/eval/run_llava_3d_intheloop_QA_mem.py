...
def eval_model(args):
    ...
    with open('/local1/whu/data/hm3d/train_data/llava-3d_data_Feb28_v6_medium_180_scenes_18x10k_gemini_annotation_TrainQA_longtermmem_865_evaluation_samples.json', 'r') as f: 
        annotations = json.load(f)

    # random.seed(123)
    # annotations = random.sample(annotations, 50)

    # with open('/local1/whu/data/hm3d/train_data/llava-3d_data_Feb28_v6_medium_180_scenes_18k_annotation_TrainQA_longtermmem_10k_eval_50.json', 'w') as f:
    ...
    outputfile = '3d_data_0327_QA_' + args.model_path.split('/')[-1] + '.json'
